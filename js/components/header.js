$(document).ready(function() {
	...
	// 	.fromTo(c1, {autoAlpha: 0, scale: 0 }, {duration: 1, autoAlpha: 1, scale: 1, stagger: 0.2}, 1)
	// 	.fromTo(c2, {autoAlpha: 0, scale: 0.4 }, {duration: .5, autoAlpha: 1, scale: 1, stagger: 0.2}, 1.5)
	// 	.fromTo(c3, {autoAlpha: 0, scale: 0.4 }, {duration: .5, autoAlpha: 1, scale: 1, stagger: 0.2}, 2)
	// 	.fromTo(c4, {autoAlpha: 0, scale: 0.4 }, {duration: .5, autoAlpha: 1, scale: 1, stagger: 0.2}, 2.5)
	// }
